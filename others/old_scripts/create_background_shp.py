...
arcpy.Buffer_analysis(Links_Final2, "in_memory/T2", "{0} Miles".format(clip_distance), "FULL", "ROUND", "NONE", "",
                      "PLANAR")
...
arcpy.SelectLayerByLocation_management('MyLinks', "WITHIN", "in_memory/T2", "", "NEW_SELECTION",
                                       "INVERT")  # takes a long time
