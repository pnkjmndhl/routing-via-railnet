...
transfer_shp_dict = {row.getValue("FID"): [row.getValue("JRR1NO"),row.getValue("JRR2NO"), row.getValue("BIDIR"), row.getValue("NEAR_FID")]  for row in arcpy.SearchCursor(transfer_shp)}
