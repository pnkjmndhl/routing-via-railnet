...
signal_capacity_to_constants_df = pandas.ExcelFile(signal_capacity_to_constants).parse("Sheet2")
...
signal_capacity_to_constants_df.columns = [
    ['trackclass', 'SIGNAL', 'CAPY_CODE', 'to', 'P1', 'P2', 'GAMMA', 'CAPACITY', 'miles']]
network_df = pandas.merge(network_df, signal_capacity_to_constants_df, how='left', left_on=['SIGNAL', 'CAPY_CODE'],
